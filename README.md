...
The CNN uses the im2col method for backpropagation. Essentially, instead of using an inefficient nested loop, the needed operations are converted into one big matrix multiplication. By using already optimised matrix multiplication libraries, a far better time-efficiency can be achieved at the cost of more memory.
# Usage
