...
- **Dropout on fully connected layers, not conv.** Dropout on convolutional feature maps is counterintuitive, as contiguous activations are correlated. This is opposed to linear connected layers, which can be thought of as independent units.
